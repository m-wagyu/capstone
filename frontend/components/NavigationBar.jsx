          ...
          <Navbar.Collapse className="justify-content-end">
            <Nav>
              ...
              <Nav.Item>
                ...
                >
                  <NavDropdown.Item
                    onClick={(e) => handleServerAction("proc_start", e)}
                  >
                    <span className="text-success">Start</span>
                  </NavDropdown.Item>
                  <NavDropdown.Item
                    onClick={(e) => handleServerAction("proc_reload", e)}
                  >
                    <span className="text-warning">Reload</span>
                  </NavDropdown.Item>
                  <NavDropdown.Item
                    onClick={(e) => handleServerAction("proc_stop", e)}
                  >
                    <span className="text-danger">Terminate</span>
                  </NavDropdown.Item>
                  <NavDropdown.Divider />
                  <NavDropdown.Item
                    onClick={(e) => handleServerAction("refresh", e)}
                  >
                    <span className="text-primary">Refresh Status</span>
                  </NavDropdown.Item>
                  <NavDropdown.Divider />
